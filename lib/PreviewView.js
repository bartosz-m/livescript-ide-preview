...
module.exports = PreviewView = {
  ...
  init: function(arg$){
    var extension, pane, sourceGrammar, ProviderManager, x$;
    ...
    x$.add(this.origin.onDidStopChanging(bind$(this, 'render')));
  ...
  syncScroll: function(top){
    ...
    this.lastTop = top;
    screenPosition = this.origin.screenPositionForPixelPosition({
      top: top + delta,
      left: 0
    });
