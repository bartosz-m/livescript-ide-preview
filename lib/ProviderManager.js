...
module.exports = {
  ...
  updatedConfig: function(){
    var schema, i$, ref$, len$, provider, x$, providerSchema, ref1$, key$;
    schema = {
      type: 'object',
      properties: {}
    };
    for (i$ = 0, len$ = (ref$ = this.providers).length; i$ < len$; ++i$) {
      provider = ref$[i$];
      x$ = providerSchema = (ref1$ = schema.properties)[key$ = provider.fromGrammarName] || (ref1$[key$] = {});
      x$.type = 'string';
      x$['default'] = provider.name;
      (x$['enum'] || (x$['enum'] = [])).push({
        value: provider.name,
  ...
  registerProvider: function(provider){
    ...
    if (provider != null && !this.isProviderRegistered(provider)) {
      ...
      atom.config.setSchema('atom-livescript-ide-preview.provider', this.updatedConfig());
...
//# sourceMappingURL=/home/bartek/Projekty/atom/atom-livescript-ide-preview/lib/ProviderManager.js.map
